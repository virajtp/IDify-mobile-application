...
class _TransactionsState extends State<Transactions> {
  ...
  void initState() {
    super.initState();
    fetchTransactionsFromDatabase(); // Fetch transactions from the database
  }

  void fetchTransactionsFromDatabase() {
    ...
    // transactions = await DatabaseProvider.fetchTransactions();
  }
      ...
      body: Column(
        children: [
          Container(
            ...
            child: ThemeAppBar.appBar(context, title: "Transactions"),
          ),
          Expanded(
            child: Container(
